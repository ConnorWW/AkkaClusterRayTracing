...
object Main extends App {
  ...
  val lights = List(PhotonSource(PointLight(RTColor(1, 1, 1), Point(1, 0, .2)), 800000)/*, PhotonSource(PointLight(RTColor(1, 0, 0), Point(-1e-1, 0, 1e-2)), 40000*/)
  ...
  val view = GeometrySetup.positiveYView()
  ...
  val organizer = system.create(GeometryOrganizerSome[PhotonCreator.PhotonCreatorIntersectResult](particles, PhotonCreator.PhotonCreatorIntersectResult.apply), "GeomOrganizer")
